...
class Admin_assign_subject extends MY_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('employee_assign_subject_model', 'class_subject');
    }

    public function index() {
        $data['include'] = 'admin/class_subject/employee_assign_subject';
		$data['title'] = "Assign Subjects(Chapter & Question) ";    
        ...
        $i=1;
         foreach ($list as $class_subject) {
           ...
           if ($class_subject->status == 'Y')
            ...
            $row[] = ' <a href="admin_chapter?clas_sub_id='.$class_subject->id.'" class="btn btn-warning" title="Add chapter"> <i class="fa fa-plus"></i></a> '; 
