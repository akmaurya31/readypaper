...
class Admin_classsub_exercise extends MY_Controller {
    ...
    public function index() {
        $data['include'] = 'admin/class_subject/class_classsub_exercise';
		$data['title'] = "Exercise Subjects Wise";    
    ...
    public function ajax_list() {
      ...
      foreach ($list as $class_subject) {
           ...
           if ($class_subject->status == 'Y')
            ...
            $row[] = '' . $statusIs . ' <a href="admin_exercise?class_subj_id='.$class_subject->id.'" class="btn btn-primary" title="Add exercise"> <i class="fa fa-plus"></i></a> '; 
