			...
			<div class="col-lg-12">
				<div class="card shadow ">
					<div class="card-body">
						...
						echo form_open_multipart("admin_teacher_ad/menusEdit?editId={$_GET['editId']}", $attributes); ?>
						...
						<div class="row">
							...
							<div class="col-md-3">
								...
								<div class="form-group">
									<label>Ads/ Logo Images</label>
									<img style="width:20%" src="<?php echo base_url()?>upload/company/<?php echo $proResult->pic; ?>">
