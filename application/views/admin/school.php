...
var table;
    ...
    var controllerListUrl = '<?php echo site_url('admin_school/ajax_list') ?>';
    var statusUrl = '<?php echo site_url('admin_school/activeInactivestatusUpdate') ?>';
    var deleteUrl = "<?php echo site_url('admin_school/ajax_delete') ?>";
...
function edit_school(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('admin_school/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            if(data.pic)
            {
                ...
                $('#photo-preview div').html('<img src="'+base_url+'upload/admin-school/'+data.pic+'" class="img-responsive" style="width:30%">'); // show photo
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('admin_school/ajax_add')?>";
    } else {
        url = "<?php echo site_url('admin_school/ajax_update')?>";
    }
           ...
           <div class="basic-form">
                    <form id="form" class="user">
                        ...
                        <div class="form-group row mb-3 ">                       
                            ...
                            <label class="col-form-label col-sm-4"><?= $title?>  Logo</label>
                        <div class="col-sm-8">
