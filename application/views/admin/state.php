...
var table;
    ...
    var controllerListUrl = '<?php echo base_url('admin_state/ajax_list') ?>';
    var statusUrl = '<?php echo base_url('admin_state/activeInactivestatusUpdate') ?>';
    var deleteUrl = "<?php echo base_url('admin_state/ajax_delete') ?>";
...
function add_category()
{
    ...
    $('.modal-title').text('Add state'); // Set Title to Bootstrap modal title
...
function edit_state(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('admin_state/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('admin_state/ajax_add')?>";
    } else {
        url = "<?php echo site_url('admin_state/ajax_update')?>";
    }
